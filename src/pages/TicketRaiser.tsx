  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      try {
        ...
        console.warn('generate_ticket_number RPC failed, falling back to client-side generation', rpcErr);
      ...
      toast({
        ...
        description: primaryRole === 'hod' ? `Your request ${data.ticket_number} was sent to Principal for approval` : `Your ticket has been raised with number: ${data.ticket_number}`,
      });
    ...
    <Layout>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Fill out the form below to raise an issue ticket. You will receive updates on the status of your ticket.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                title={primaryRole === 'hod' ? 'Department is set from your HOD assignment' : undefined}
              />
            </div>
              ...
              >
                ...
                <SelectContent>
                  {categoriesLoading ? (
                    ...
                    (categories.length ? categories : [{ value: 'inventory', label: 'Inventory' }]).map((category) => (
            ...
            <Button type="submit" disabled={submitting} className="w-full">
              {submitting ? 'Submitting...' : (primaryRole === 'hod' ? 'Request Principal Approval' : 'Raise Ticket')}
            </Button>
          </form>
        </CardContent>
      </Card>
