        ...
        <Tabs defaultValue="request" className="w-full space-y-4">
          <div className="w-full overflow-x-auto pb-1 scrollbar-none">
            <TabsList className="inline-flex w-auto min-w-full sm:min-w-0 sm:grid sm:grid-cols-2 h-auto p-1.5 gap-1.5 bg-slate-200/70 dark:bg-slate-800/80 rounded-xl">
              <TabsTrigger
                value="request"
                className="font-semibold text-xs sm:text-sm py-2 px-4 whitespace-nowrap rounded-lg data-[state=active]:bg-white dark:data-[state=active]:bg-slate-900 data-[state=active]:shadow-sm"
              >
                Request Quotation
              </TabsTrigger>
              <TabsTrigger
          ...
          <TabsContent value="view">
            <Card>
              <CardHeader>
                ...
                <CardDescription>View sent quotation requests grouped by category</CardDescription>
              </CardHeader>
              <CardContent>
                <Accordion type="single" collapsible className="w-full">
                  {Object.entries(
                    groupedQuotations as Record<string, { category: any; quotations: any[] }>,
                  ).map(([catId, { category, quotations: catQuotations }]) => (
                                        ...
                                        <div className="mt-2">
                                          ...
                                          <div className="text-sm space-y-1">
                                            <p>
                                              ...
                                              {quotation.quotation_responses[0].total_amount}
                                            </p>
                                            <p>
                                              <strong>Submitted:</strong>{" "}
                                              {new Date(
                                                quotation.quotation_responses[0].submitted_at,
                                              ).toLocaleDateString()}
                                            </p>
                                                    ...
                                                    {quotation.quotation_responses[0].description
                                                      ...
                                                      .map((section: string, index: number) => {
                                                        if (section.startsWith("Delivery Time:")) {
                                                          ...
                                                          section.startsWith("Contact Person:")
                                                        ) {
                                                          return (
                                                            <p key={index}>
                                                          ...
                                                          section.startsWith("Payment Terms:")
                                                        ) {
                                                          return (
                                                            <p key={index}>
