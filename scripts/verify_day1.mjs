...
const rules = [
  { category: 'small_value', method: 'direct_purchase', per_txn_limit: 2000, per_month_limit: 5000, approval_role: 'hod', min_quotations: 0, requires_rate_contract: false, active: true },
  { category: 'small_value', method: 'small_value_po', per_txn_limit: 5000, per_month_limit: 30000, approval_role: 'principal', min_quotations: 0, requires_rate_contract: false, active: true },
  { category: 'small_value', method: 'small_value_po', per_txn_limit: 5000, per_month_limit: 30000, approval_role: 'procurement_officer', min_quotations: 0, requires_rate_contract: false, active: true },
  { category: 'routine_consumable', method: 'rate_contract', per_txn_limit: null, per_month_limit: 100000, approval_role: 'procurement_officer', min_quotations: 3, requires_rate_contract: true, active: true },
  { category: 'equipment_asset', method: 'comparative_quotations', per_txn_limit: 10000, per_month_limit: 50000, approval_role: 'purchase_committee', min_quotations: 3, requires_rate_contract: false, active: true },
  { category: 'software', method: 'comparative_quotations', per_txn_limit: 10000, per_month_limit: 50000, approval_role: 'purchase_committee', min_quotations: 3, requires_rate_contract: false, active: true },
  { category: 'academic_research', method: 'comparative_quotations', per_txn_limit: 10000, per_month_limit: 50000, approval_role: 'purchase_committee', min_quotations: 3, requires_rate_contract: false, active: true },
  { category: 'services_amc', method: 'comparative_quotations', per_txn_limit: 10000, per_month_limit: 50000, approval_role: 'purchase_committee', min_quotations: 3, requires_rate_contract: false, active: true },
  { category: 'maintenance', method: 'comparative_quotations', per_txn_limit: 10000, per_month_limit: 50000, approval_role: 'purchase_committee', min_quotations: 3, requires_rate_contract: false, active: true },
];
...
console.log('✓ Test 2 Passed: ₹15,000 Equipment escalates to EVP (exceeds ₹10,000 Purchase Committee cap)');
...
assert(t3.role === 'principal' || t3.role === 'procurement_officer', 'Test 3 Failed: Should resolve to Principal/Procurement Officer');
...
assert(t4.role === 'principal' || t4.role === 'procurement_officer', 'Test 4 Failed: Should route to Principal when HOD month cap breached');
...
function checkEmpanelmentApprovalPermission(roles) {
  ...
  return { ok: false, error: `You are not permitted to approve vendor empanelment. Required role: evp. You hold: ${roles.join(', ') || 'none'}.` };
}
